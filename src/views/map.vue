...
// const dr = 4.8 // 正六边形的边长 "echarts": "^4.8.0"
const siteMap = {
...
function init() {
  ...
  container = echarts.init(containerRef.value)
  console.log(getOption(dataJson))
  container?.setOption(getOption(dataJson))
  /*{
    series: [
      {
        name: '香港18区人口密度',
 ...
 */
function getOption(chinaJson) {
  console.log(chinaJson, 'sss')
  return {
    tooltip: {
      show: false
    },
            ...
            children: [
              {
                ...
                textContent: {
                  style: {
                    text: '滴滴答答',
                    font: 'bolder 1em "Microsoft YaHei"',
                    fill: '#000'
                  }
                },
                textConfig: {
...
<template>
  <div ref="containerRef" id="container"><span>ddd</span></div>
</template>
